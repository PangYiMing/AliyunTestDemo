...
public class RNAliyunPlayer extends RelativeLayout {
     ...
     * 初始化界面
     */
    public void initUI(RNAliyunPlayerCallBack callBack, AppCompatActivity activity) {
...
//    }
    ...
    private class MyDownloadInfoListener implements AliyunDownloadInfoListener {
        ...
        public void onError(AliyunDownloadMediaInfo info, int code, String msg, String requestId) {
            ...
            playerHandler = new RNAliyunPlayer.PlayerHandler(activity);
    ...
    private static class PlayerHandler extends Handler {
        ...
        private final WeakReference<AppCompatActivity> mActivty;

        public PlayerHandler(AppCompatActivity activity) {
            mActivty = new WeakReference<AppCompatActivity>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            AppCompatActivity activity = mActivty.get();
